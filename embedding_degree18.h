...
void EFp3_set_EFp18_Sparse(struct EFp3 *ANS,struct EFp18 *A);//set EFp18 sparse point for EFp3
...
void Sparse_Miller_algo(struct Fp18 *ANS,struct EFp3 *P,struct EFp3 *Q,mpz_t roop);
...
void Sparse_DBL_LINE(struct Fp18 *l_ANS,struct EFp3 *T_ANS,struct EFp3 *T,struct EFp3 *Q,struct Fp3 *Px_neg);

void Pseudo_Sparse_Miller(struct Fp18 *ANS,struct EFp3 *P,struct EFp3 *Q,mpz_t roop);
void Pseudo_Sparse_Ate_Pairing(struct Fp18 *ANS,struct EFp3 *P,struct EFp3 *Q);
...
void ltt_q_Sparse(struct Fp18 *ANS,struct EFp3 *Q,struct EFp3 *R);
void ltp_q_Sparse(struct Fp18 *ANS,struct EFp3 *Q,struct EFp3 *R,struct EFp3 *P);
void ltt_q_Pseudo_Sparse(struct Fp18 *ANS,struct EFp3 *Q,struct EFp3 *R,struct Fp3 *L);
void ltp_q_Pseudo_Sparse(struct Fp18 *ANS,struct EFp3 *Q,struct EFp3 *R,struct EFp3 *P,struct Fp3 *L);
