...
echo "- Linking..."
gcc -o pairing_deg18 main.o parameters.o Finite_Field.o embedding_degree18.o -lgmp
...
if [ "$BUILD_BENCH" = true ]; then
    ...
    gcc -o benchmark benchmark.o parameters.o Finite_Field.o embedding_degree18.o -lgmp
